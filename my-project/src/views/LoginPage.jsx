...
import { postLogin } from "../redux/action/userAction";
        ...
        <div className="card lg:card-side bg-base-100 items w-full max-w-md">
          <div className="flex justify-center card-body items-center gap-6">
            ...
            <div className="flex flex-col items-center mb-4">
              <p className="text-3xl font-bold mt-5">Masuk atau buat akun</p>
              <p className="text-3xl font-bold">untuk memulai</p>
            </div>
            <form onSubmit={handleLogin}>
              <div className="relative w-96 mb-7">
                <svg
              ...
              <div className="relative w-96">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="maukan password anda"
